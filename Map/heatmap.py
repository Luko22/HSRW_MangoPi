"""
Program to generate a heatmap of the accidents in Berlin

This program reads the accident data and generates a heatmap of the accidents in Berlin. The heatmap is generated by dividing Berlin into a grid and 
counting the number of accidents in each grid cell. The grid is then plotted as a heatmap using matplotlib.

This heatmap can be used to visualize the distribution of accidents in Berlin and identify areas with high accident rates.
Thus providing another parameter for the predictive model to consider when predicting risk.
